...
final class Astra_Builder_Helper {
	...
	public function __construct() {
		...
		// Custom Astra fork: use full component_limit (10) without Astra Pro.
		self::$num_of_header_button = self::$component_count_array['header-button'];
		self::$num_of_footer_button = self::$component_count_array['footer-button'];

		self::$num_of_header_html = self::$component_count_array['header-html'];
		self::$num_of_footer_html = self::$component_count_array['footer-html'];

		self::$num_of_header_menu = self::$component_count_array['header-menu'];

		self::$num_of_header_widgets = self::$component_count_array['header-widget'];
		self::$num_of_footer_widgets = self::$component_count_array['footer-widget'];

		self::$num_of_header_social_icons = self::$component_count_array['header-social-icons'];
		self::$num_of_footer_social_icons = self::$component_count_array['footer-social-icons'];

		// Divider.
		self::$num_of_header_divider = self::$component_count_array['header-divider'];
		self::$num_of_footer_divider = self::$component_count_array['footer-divider'];
	...
	public function initialize() {
		...
		if ( false && ! defined( 'ASTRA_EXT_VER' ) ) {
	...
	public static function get_component_count() {
		...
		$component_keys_count = array(
			'header-button'       => self::$component_limit,
			'footer-button'       => self::$component_limit,
			'header-html'         => self::$component_limit,
			'footer-html'         => self::$component_limit,
			'header-menu'         => self::$component_limit,
			'header-widget'       => self::$component_limit,
			'footer-widget'       => self::$component_limit,
			'header-social-icons' => self::$component_limit,
			'footer-social-icons' => self::$component_limit,
			'header-divider'      => self::$component_limit,
			'footer-divider'      => self::$component_limit,
			'removed-items'       => array(),
		);
