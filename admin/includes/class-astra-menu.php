...
class Astra_Menu {
	 ...
	 */
	public static $page_title = 'Forge';
	 ...
	 */
	public static $plugin_slug = 'forge';
	...
	public function setup_menu() {
		...
		self::$page_title = apply_filters( 'astra_page_title', esc_html__( 'Forge', 'astra' ) );
		...
		$show_learn_tab = isset( $admin_settings['show_learn_tab'] ) ? $admin_settings['show_learn_tab'] : false;
	...
	public function render_admin_dashboard() {
		if ( function_exists( 'forge_render_admin_dashboard' ) ) {
			forge_render_admin_dashboard();
			return;
		}
	...
	public function styles_scripts() {
		...
		$localize = array(
			...
			'show_learn_tab'            => Astra_API_Init::get_admin_settings_option( 'show_learn_tab', false ),
			'show_ai_assistant'         => Astra_API_Init::get_admin_settings_option( 'show_ai_assistant', false ),
		);
